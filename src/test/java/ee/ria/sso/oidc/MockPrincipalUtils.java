...
public class MockPrincipalUtils {
    ...
    public static final String MOCK_PHONE_NUMBER = "+3725123123";
    ...
    public static HashMap<String, Object> getMockMidAuthPrincipalAttributes() {
        ...
        map.put(PHONE_NUMBER.name(), Arrays.asList(MOCK_PHONE_NUMBER));
        map.put(PHONE_NUMBER_VERIFIED.name(), Arrays.asList(true));
